...
export default function B2BAndFooter() {
  ...
  const handleFooterContact = () => {
    window.location.href = "mailto:seoah.lab@gmail.com";
  };
      ...
      <section className="relative bg-[#1D352D] py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="text-[#FCFBF7] font-sans font-light text-4xl md:text-5xl tracking-wide leading-relaxed mb-12">
              자주 묻는 질문
            </h2>
            <p className="text-[#FCFBF7]/60 font-sans text-base tracking-wide leading-relaxed">
              궁금한 점이 있으신가요?
            </p>
          </motion.div>

          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden py-6">
